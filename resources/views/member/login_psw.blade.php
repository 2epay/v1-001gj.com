...
<div id="main-menu">
	<div class="menu-area">
		<ul class="list-group">
			...
			<li class="list-group-item member-password active"><a href="javascript:void(0)">修改密码</a></li>
		</ul>
	</div>
</div>
...
<div id="main-container">
	<div class="module-top">
		<div class="top-menu-area">
			<a href="javascript:void(0)" class="active">修改登录密码</a>
			<a href="{{ route('member.safe_psw') }}">修改取款密码</a>
		</div>
	</div>		
	<div class="module-main" style="height: 630px; overflow: auto;margin-top:20px">
		<form action="{{ route('member.update_login_password') }}" method="post" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-xs-6">
					<input id="mdl-37_repassword" name="password_confirmation" type="password" class="form-control">
				</div>
				<div class="col-xs-3 info">
					* 6-20个常规字符
				</div>
