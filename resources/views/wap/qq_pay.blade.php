        ...
        <div class="m_body">
            <div class="container-fluid gm_main">
                ...
                <div class="userInfo wrap" style="padding: 10px;">
                    <p class="text-center" style="margin-bottom: 10px;">二维码扫一扫，QQ钱包快捷支付，100%安全！</p>
                    <table class="text-center" width="100%" border="0" cellpadding="0" cellspacing="1">
                        <tbody>
                        <tr>
                            <td style="width: 35%">收款账号</td>
                            <td>
                        ...
                        <tr>
                            <td>QQ钱包收款二维码（手机截屏后进行扫码）</td>
                            <td>
                                <img src="{{ $_system_config->qq_qrcode }}" width="200" height="200"
                    ...
                    <div style="border: 1px solid #ccc;padding: 10px;">
                        ...
                        <p>二、本公司最低存款金额为1元，公司财务系统将对银行存款的会员按实际存款金额实行返利派送。</p>
                        <p>三、跨行转帐请您使用跨行快汇。</p>
                    </div>
