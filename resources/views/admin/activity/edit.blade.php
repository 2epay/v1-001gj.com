                ...
                <form class="form-horizontal" id="form" action="{{ route('activity.update', ['id' => $data->getKey()]) }}" method="post">
                    ...
                    <div class="box-body">
                                ...
                                <div id="files" class="files">
                                    @if($data->title_img)
                                        <div class="pull-left" style="position:relative;margin: 10px;">
                                            <a href="{{ $data->title_img }}" target="_blank"><img src="{{ $data->title_img }}" alt="" style="width: 100%;"></a>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="number" class="form-control" id="direct_money" name="direct_money" placeholder="注册活动专用，其他活动无需填写" value="{{ $data->direct_money }}" />
                            </div>
                        </div>						
                        {{--<div class="form-group">--}}
