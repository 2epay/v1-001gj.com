                ...
                <form class="form-horizontal" id="form" action="{{ route('activity.store') }}" method="post">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <label for="end_at" class="col-sm-1 control-label">截止时间</label>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="number" class="form-control" id="money" name="money" placeholder="首存、充值活动专用"/>
                            </div>

                            <label for="rate" class="col-sm-1 control-label">赠送比例</label>
                            <div class="col-sm-3">
                                <input type="number" class="form-control" id="rate" name="rate" placeholder="首存、充值活动专用"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="gift_limit_money" class="col-sm-2 control-label">赠送金额上限</label>
                            <div class="col-sm-7">
                                <input type="number" class="form-control" id="gift_limit_money" name="gift_limit_money" placeholder="首存、充值活动专用"/>
                            </div>
                        </div>
						
                        <div class="form-group">
                            <label for="direct_money" class="col-sm-2 control-label">直接赠送金额</label>
                            <div class="col-sm-7">
                                <input type="number" class="form-control" id="direct_money" name="direct_money" placeholder="注册活动专用" />
                            </div>
                        </div>
                        {{--<div class="form-group">--}}
