                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="home">
                            <form class="form-horizontal" id="form" action="{{ route('system_config.update', ['id' => 1]) }}" method="post">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="is_alert_on" class="col-sm-2 control-label"><span style="color: red">是否开启弹框 ahau</span></label>
                                        <div class="col-sm-7">
                                            <label><input type="radio" name="is_alert_on"  value="1" @if($data->is_alert_on == 1)checked @endif />开放 open</label>
                                            <label><input type="radio" name="is_alert_on"  value="0" @if($data->is_alert_on == 0)checked @endif />关闭 close</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div role="tabpanel" class="tab-pane" id="messages">
                            <form class="form-horizontal" id="form" action="{{ route('system_config.update', ['id' => 1]) }}" method="post">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="is_wechat_on" class="col-sm-2 control-label"><span style="color: red">是否开放在线扫码</span></label>
                                        <div class="col-sm-7">
                                    ...
                                    <div class="form-group">
                                        <label for="qq_nickname" class="col-sm-2 control-label">QQ钱包昵称</label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="qq_nickname" name="qq_nickname"  value="{{ $data->qq_nickname }}" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="qq_account" class="col-sm-2 control-label">QQ钱包账号</label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="qq_account" name="qq_account"  value="{{ $data->qq_account }}" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="subtitle" class="col-sm-2 control-label">QQ钱包二维码</label>
                                        <div class="col-sm-7">
                                            <input id="fileupload14" type="file" name="file" multiple>
                                            <div id="progress4" class="progress">
                                                <div class="progress-bar progress-bar-success"></div>
                                            </div>
                                        </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="settings">
                            <form class="form-horizontal" id="form" action="{{ route('system_config.update', ['id' => 1]) }}" method="post">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="third_userid" class="col-sm-2 control-label">网银第三方userid</label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="third_useridw" name="third_useridw" placeholder="例：9999" value="{{ $data->third_useridw }}"  />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="third_userkey" class="col-sm-2 control-label">网银第三方userkey</label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="third_userkeyw" name="third_userkeyw" placeholder="例：011d495aaaab9611cd7f1f31ccaaa9377c565aaa15" value="{{ $data->third_userkeyw }}"  />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="third_pay_url" class="col-sm-2 control-label">网银第三方 url</label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="third_pay_urlw" name="third_pay_urlw" placeholder="third_pay_urlw" value="{{ $data->third_pay_urlw }}"  />
                                        </div>
                                    </div>
                                </div><!-- /.box-body -->
                                <div class="box-footer">
                        ...
                        <div role="tabpanel" class="tab-pane" id="payment">
                            <form class="form-horizontal" id="form" action="{{ route('system_config.update', ['id' => 1]) }}" method="post">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="sms_key" class="col-sm-2 control-label">Payment ID</label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="payment_id" name="payment_id" placeholder="例：3065859557 " value="{{ $data->payment_id }}"  />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="sms_token" class="col-sm-2 control-label">Payment Key</label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="payment_key" name="payment_key" placeholder="例：670c825c88b2f18732a4cf3e591eb282" value="{{ $data->payment_key }}"  />
                                        </div>
                                    </div>
                                </div><!-- /.box-body -->
                                <div class="box-footer">
