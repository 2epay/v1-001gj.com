    ...
    <section class="content">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form class="form-horizontal" id="form" action="{{ route('game_list.store') }}" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7" style=" overflow:hidden;">
                                <input type="text" class="form-control" id="img_pc" name="img_pc" style=" width:200px; float:left;"/>
