    ...
    <section class="content">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form class="form-horizontal" id="form" action="{{ route('game_list.update', ['id' => $data->id]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="client_type" class="col-sm-2 control-label">游戏线路 <strong style="color: red">*</strong></label>
                            <div class="col-sm-7">
                                <select name="game_line" id="game_line" class="form-control">
                                    <option value="">--请选择--</option>
									@foreach(config('platform.game_line') as $k => $v)
										<option value="{{ $k }}" @if($data->game_line == $k) selected @endif>{{ $v }}</option>
									@endforeach
                                </select>
                            </div>
                        </div>						
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7" style=" overflow:hidden;">
                                <input type="text" class="form-control" id="img_pc" name="img_pc" value="{{ $data->img_pc }}" style=" width:200px; float:left;"/>
                                <input type="file" name="fileto" id="fileto" style=" float:left;"/>
                            </div>
                        </div>
                        <div class="form-group">
