                ...
                <form class="form-horizontal" id="form" action="{{ route('api.store') }}" method="post">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="api_title" name="api_title" placeholder="API别名"/>
                            </div>
                        </div>	
						<div class="form-group">
                            <label for="sort" class="col-sm-2 control-label">开始游戏</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="start_game_link" name="start_game_link" placeholder="输入开始游戏链接"/>
                            </div>
                        </div>	
                        <div class="form-group">
