...
//            ],
        ...
        'submenus' => [
            [
                ...
                'actions' => [
                    ...
                    [
                        'name' => '编辑单页',
                        'router' => 'single.update'
                    ],
                    [
                        'name' => '删除单页',
                        'router' => 'single.destroy'
                    ]
                ]
            ]		
        ]
    ...
    'hongbao' => [
        ...
        'submenus' => [
            [
                'title' => '红包设置',
                'router' => 'hb_setting.index',
                'icon' => 'fa fa-circle-o',
                'is_hide' => 1,
                'actions' => [
                    [
                        'name' => '新增设置',
                        'router' => 'hb_setting.store'
                    ],
                    [
                        'name' => '编辑设置',
                        'router' => 'hb_setting.update'
                    ],
                    [
                        'name' => '删除设置',
                        'router' => 'hb_setting.destroy'
                    ]
                ]
            ],
            [
                'title' => '领取红包',
                'router' => 'hb_list.index',
                'icon' => 'fa fa-circle-o',
                'is_hide' => 1,
                'actions' => [
                    [
                        'name' => '删除记录',
                        'router' => 'hb_list.destroy'
                    ]
                ]
            ]
        ]
