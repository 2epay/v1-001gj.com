...
function LoadHongBao()
{
	...
	{
	    hongbaostr+="<img src=\"web/css/hongbao/hongbao.png\" style=\"width:"+FunMath(50,imgwidth)+"px; top:-"+FunMath(imgheight,500)+"px; left:"+FunMath(0,width-imgwidth)+"px\" onclick=\"qing()\" />"
	}
