...
var ACCOUNT_WORDS   =  {WORD:"账号",WORDSREQ:{REQ1:"请输入您的账号！",REQ2:"帐号为字母开头，6-12位的字母与数字组合！",REQ3:"test开头的是试玩会员，不允许作为正式账号！"},WORDSERROR:"账号输入错误！",WORDSCORRECT:"帐号为字母开头，6-12位的字母与数字组合！",WORDSWARN:""};
var PASSWORD_WORDS  =  {WORD:"密码",WORDSREQ:{REQ1:"请输入您的密码！",REQ2:"密码不能与账号相同！",REQ3:"密码长度不能少于6个字符！",REQ4:"密码必须是6-12位字母与数字的组合！"},WORDSERROR:"确认密码错误！请重新输入！",WORDSCORRECT:"密码为6-12位字母与数字的组合！",WORDSWARN:""};
var REALNAME_WORDS  =  {WORD:"真实姓名",WORDSREQ:{REQ1:"请输入真实姓名！",REQ2:"真实姓名只能1-12位！",REQ3:"姓名已注册, 请洽客服人员！"},WORDSERROR:"真实姓名输入错误！",WORDSCORRECT:"必须与您的银行账户名称相同，否则不能出款！",WORDSWARN:""};
...
var QKPASS_WORDS    =  {WORD:"密码",WORDSREQ:{REQ1:"请输入您的取款密码！",REQ2:"请输入6位取款密码！"},WORDSERROR:"密码输入错误！",WORDSCORRECT:"取款时要用到的密码，非常重要，请务必牢记！",WORDSWARN:""};
