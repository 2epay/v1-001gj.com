...
f_com.CasinoHtmlAG = function(Cat,Gcat,lang,pag,sear){
	var data = {"Category": Cat, "Game_category": Gcat, "Langx": lang, "page": pag, "search": sear};
	$.ajax({   
		url:'/cl/ag_game.php',   
		type:'post',   
...
f_com.CasinoHtmlYOPLAY = function(Cat,Gcat,lang,pag,sear){
	var data = {"Category": Cat, "Game_category": Gcat, "Langx": lang, "page": pag, "search": sear};
	$.ajax({   
		url:'/cl/yoplay_game.php',   
		type:'post',   
		data:data,   
		//async : false, //默认为true 异步   
		error:function(){   
...
f_com.CasinoHtmlBB = function(Cat,Gcat,lang,pag,sear){
	var data = {"Category": Cat, "Game_category": Gcat, "Langx": lang, "page": pag, "search": sear};
	$.ajax({   
		url:'/cl/bbin_game.php',   
		type:'post',   
		data:data,   
		//async : false, //默认为true 异步   
		error:function(){   
...
f_com.CasinoHtmlMW = function(Cat,Gcat,lang,pag,sear){
	var data = {"Category": Cat, "Game_category": Gcat, "Langx": lang, "page": pag, "search": sear};
	$.ajax({   
		url:'/cl/mw_game.php',   
		type:'post',   
...
f_com.CasinoHtmlPT = function(Cat,Gcat,lang,pag,sear){
	var data = {"Category": Cat, "Game_category": Gcat, "Langx": lang, "page": pag, "search": sear};
	$.ajax({   
		url:'/cl/pt_game.php',   
		type:'post',   
...
f_com.CasinoHtmlHB = function(Cat,Gcat,lang,pag,sear){
	var data = {"Category": Cat, "Game_category": Gcat, "Langx": lang, "page": pag, "search": sear};
	$.ajax({   
		url:'/cl/hb_game.php',   
		type:'post',   
...
f_com.CasinoHtmlFGH = function(Cat,Gcat,lang,pag,sear){
	var data = {"Category": Cat, "Game_category": Gcat, "Langx": lang, "page": pag, "search": sear};
	$.ajax({   
		url:'/cl/fgh_game.php',   
		type:'post',   
...
f_com.CasinoHtmlFGDZ = function(Cat,Gcat,lang,pag,sear){
	var data = {"Category": Cat, "Game_category": Gcat, "Langx": lang, "page": pag, "search": sear};
	$.ajax({   
		url:'/cl/fgdz_game.php',   
		type:'post',   
		data:data,   
		//async : false, //默认为true 异步   
		error:function(){   
...
f_com.CasinoHtmlGNS = function(Cat,Gcat,lang,pag,sear){
	var data = {"Category": Cat, "Game_category": Gcat, "Langx": lang, "page": pag, "search": sear};
	$.ajax({   
		url:'/cl/gns_game.php',   
		type:'post',   
...
f_com.CasinoHtmlISB = function(Cat,Gcat,lang,pag,sear){
	var data = {"Category": Cat, "Game_category": Gcat, "Langx": lang, "page": pag, "search": sear};
	$.ajax({   
		url:'/cl/isb_game.php',   
		type:'post',   
...
f_com.CasinoHtmlJDB = function(Cat,Gcat,lang,pag,sear){
	var data = {"Category": Cat, "Game_category": Gcat, "Langx": lang, "page": pag, "search": sear};
	$.ajax({   
		url:'/cl/jdb_game.php',   
		type:'post',   
...
f_com.CasinoHtmlCQ = function(Cat,Gcat,lang,pag,sear){
	var data = {"Category": Cat, "Game_category": Gcat, "Langx": lang, "page": pag, "search": sear};
	$.ajax({   
		url:'/cl/cq_game.php',   
		type:'post',   
...
f_com.CasinoHtmlPG = function(Cat,Gcat,lang,pag,sear){
	var data = {"Category": Cat, "Game_category": Gcat, "Langx": lang, "page": pag, "search": sear};
	$.ajax({   
		url:'/cl/pg_game.php',   
		type:'post',   
...
function sMsgReset(id,o,t,b){
	try{
		...
		for(var skey in sMsgArr){
				sMsgRe += sFirst+sMsgArr[skey]+sEnd;
...
function LeboCSlink(){
	...
	try{
		if(kf01.length>0){
			...
			window.open( kf03 , '在线客服', 'width='+(window.screen.availWidth-10)+',height='+(window.screen.availHeight-30)+',top=0,left=0,status=yes,toolbar=no,scrollbars=yes,resizable=no,personalbar=no');
		}
	}catch(e){
		alert("客服系统故障，请稍等");
	}
...
$(document).ready(function(){
	if(top.kfShow !== undefined){
		...
		if(kfCode.length>0){
			kfCode.hide(0);
			$(".csLink").attr("onclick",kfCode.attr("onclick"));
		}
...
function startRequest(dType) {
	...
	var detailType = dType || "",moneyArr = [
			{gameType: "lebo" ,gameUrl: "/app/member/getCredit.php?uid="+top.uid+"&lang="+top.langx+"&"+Math.random()},//系统余额 lebo_money {MONEY}
			{gameType: "mg" ,gameUrl:"/mgame/index.php?action=GetAccountBalance"+detailType+"&v="+Math.random()}, //MG mg_money {MG_MONEY}
            {gameType: "bg" ,gameUrl:"/BGgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //BG bg_money {BG_MONEY}
			{gameType: "ag" ,gameUrl:"/AGgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //AG ag_money {AG_MONEY}
			{gameType: "ct" ,gameUrl:"/CTgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //CT ct_money {CT_MONEY}
			{gameType: "bbin" ,gameUrl:"/BBINgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //BBIN bbin_money {BB_MONEY}
			{gameType: "og" ,gameUrl:"/OGgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //OG og_money {OG_MONEY}
			{gameType: "xtd" ,gameUrl:"/GCgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //GC xtd_money {GC_MONEY}
			{gameType: "dg" ,gameUrl:"/DGgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //DG dg_money {DG_MONEY}
			{gameType: "sb" ,gameUrl:"/sbapi/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //沙巴 sb_money {SB_MONEY}
			{gameType: "mw" ,gameUrl:"/MWgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //MW mw_money {MW_MONEY}
			{gameType: "pt" ,gameUrl:"/PTgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //PT pt_money {PT_MONEY}
			{gameType: "hb" ,gameUrl:"/HBgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //HB hb_money {HB_MONEY}
			{gameType: "lmg" ,gameUrl:"/LMGgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //LMG lmg_money {LMG_MONEY}
			{gameType: "gdc" ,gameUrl:"/GDCgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //GDC gdc_money {GDC_MONEY}
			{gameType: "hp" ,gameUrl:"/HPgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //HP hp_money {HP_MONEY}
			{gameType: "via" ,gameUrl:"/VIAgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //VIA via_money {VIA_MONEY}
			{gameType: "ob" ,gameUrl:"/OBgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //OB ob_money {OB_MONEY}
			{gameType: "fg" ,gameUrl:"/FGgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //FG fg_money {FG_MONEY}
			{gameType: "gns" ,gameUrl:"/GNSgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //GNS gns_money {GNS_MONEY}
			//{gameType: "isb" ,gameUrl:"/ISBgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //ISB isb_money {ISB_MONEY}
			{gameType: "jdb" ,gameUrl:"/JDBgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //JDB jdb_money {JDB_MONEY}
			{gameType: "hp" ,gameUrl:"/HPgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //HP hp_money {HP_MONEY}
			{gameType: "cq" ,gameUrl:"/CQgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //CQ cq_money {CQ_MONEY}
			{gameType: "xp" ,gameUrl:"/XPgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //XP xp_money {XP_MONEY}
			{gameType: "pg" ,gameUrl:"/PGgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()}, //PG pg_money {PG_MONEY}
			{gameType: "hc" ,gameUrl:"/HCgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()} //HC hc_money {HC_MONEY}
			//{gameType: "ld" ,gameUrl:"/LDgame/index.php?action=UserDetails"+detailType+"&v="+Math.random()} //LD ld_money {LD_MONEY}
		];
		...
		if( $(typeAmountId).length > 0 || $("#all_money").length>0){
			...
			$.getJSON(
				...
				function(data){
					...
					if($("#all_money").length>0 && top.all_amount_index <= moneyArr.length)$("#all_money").html(formatCurrency(top.all_amount));
...
function getNotReadCount(){
	...
	//setTimeout("getNotReadCount()",300000);
}
...
$(document).ready(function(){
  var sbspi = $('iframe');
  var SbPageSrc = sbspi.attr('src');
  if(/sbapi/.test(SbPageSrc)){
      var container = sbspi.parent();
	  $('<style>a.tiyuguize{padding: 5px 2px;display: block;width: 20px;height: auto;color: #000;position: absolute;transition: all .3s linear;}</style>').appendTo($('head'));
	  container.append('<a href="http://rrs.net2cast.com/popContents.aspx?lang=cs#top" target="_blank" class="tiyuguize">沙巴体育规则</a>');
	  var tiyu =$('.tiyuguize');
	  $("<style id='test_style'></style>").text("div#test{color:red;}").appendTo($("head"));
	  function sbspiRuleResize(){
		var offsetLeft = sbspi.offset().left;
		 var offsetTop = sbspi.offset().top;
		 tiyu.css({
			 left:offsetLeft-tiyu.outerWidth(),
			 top:offsetTop
		 });
	  }
	  sbspiRuleResize();
	  $(window).resize(sbspiRuleResize);
  }
});
/**
 * 切换验证码
 */
function change_yzm_new(obj)
{
        $("#"+obj).attr("src","/app/member/yzm_new.php?="+(new Date()).getTime());
}
/**
*添加千位符
*/
