...
Message.BackendApi = {
    ...
    DelMsg: function($cbs, ids) {
        ...
        $.post("message.aspx", { action: "del", ids: ids }, function(response) {
...
function addNavEvent(){
	$("#LS-LiveMain").mouseenter(function(){
	...
	$("#LS-LiveMain").mouseleave(function(){
	...
	$("#LS-Lottery").mouseenter(function(){
	...
	$("#LS-Lottery").mouseleave(function(){
	...
	$("[name_attr='pt']").click(function(){
        // if($(this).attr("class") == "pt_dld"){
            var buttons = {
                "我知道了":function () { dialog.close(); window.location.href="http://link.jackpotmatrix.com/";}
            };
             //   buttons[l.OK] = function () { dialog.close(); window.location.href="http://download.uedbet.com/pt/ued_cn.exe";};

            dialog.info("提示", "您正在下载的是  UED为您提供的PT娱乐城下载版。<br>登录时候,请在您的用户名前加<span style='color:red;'>ued_</span> \"例 <span style='color:red;'>ued_XXX</span>\"。",buttons);
        // }else{
